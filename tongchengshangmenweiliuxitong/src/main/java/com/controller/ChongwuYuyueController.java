...
//        }
    ...
    public R jieshou(@RequestBody ChongwuYuyueEntity ChongwuYuyueEntity, HttpServletRequest request){
        logger.debug("jieshou:,,Controller:{},,ChongwuYuyueEntity:{}",this.getClass().getName(),ChongwuYuyueEntity.toString());

        ChongwuYuyueEntity oldchongwuYuyue = chongwuYuyueService.selectById(ChongwuYuyueEntity.getId());//查询原先数据
        ChongwuYuyueEntity.setChongwuYuyueYesnoTypes(2);
    ...
    public R jujue(@RequestBody ChongwuYuyueEntity ChongwuYuyueEntity, HttpServletRequest request){
        logger.debug("jieshou:,,Controller:{},,ChongwuYuyueEntity:{}",this.getClass().getName(),ChongwuYuyueEntity.toString());

        ChongwuYuyueEntity oldchongwuYuyue = chongwuYuyueService.selectById(ChongwuYuyueEntity.getId());//查询原先数据
        ChongwuYuyueEntity.setChongwuYuyueYesnoTypes(3);
